...
export function NewPropertyForm(): React.ReactElement {
  ...
  const [inSiteValue, setInSiteValue] = useState<string>("");
  const [ensuiteBathValue, setEnsuiteBathValue] = useState<string>("");
  const [poolValue, setPoolValue] = useState<string>("");
  const [dressingRoomValue, setDressingRoomValue] = useState<string>("");
  const [furnishedValue, setFurnishedValue] = useState<string>("");
  const [balconyValue, setBalconyValue] = useState<string>("");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Varlık Ekle</h1>
          <p className="text-slate-600">Yeni varlık bilgilerini girin</p>
        </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select name="type" required className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-blue-300 focus:ring-2 focus:ring-blue-200">
                ...
                <div>
                  ...
                  <select name="listing_type" required className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-blue-300 focus:ring-2 focus:ring-blue-200">
                    <option value="">Seçiniz</option>
                ...
                <div>
                  ...
                  <select name="room_plan" className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-blue-300 focus:ring-2 focus:ring-blue-200">
                    <option value="">Seçiniz</option>
                    {ROOM_PLANS.map(plan => (
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select name="heating" className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-blue-300 focus:ring-2 focus:ring-blue-200">
                    <option value="">Seçiniz</option>
